...
输入: build_single.py 产出的 pages/00-总览台.html + pages/seed/seed.json（真实数据快照）
输出: site/index.html
...
def main():
    ...
    print('wrote site/index.html, %d bytes (jobs=%d apps=%d interns=%d inbox=%d, seed=%s)'
